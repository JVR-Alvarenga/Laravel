<x-layout title="- Admin: Criar Pizza">
    ...
    <h3>Crie Uma Nova Bebida</h3>
    <form action="{{route('create.drinks.action')}}" method="post">
        @csrf
        <input type="string" name="name" placeholder="Nome da Bebida"/>
        <input type="string" name="volume" placeholder="Volume da Bebida" />
        <input type="double" name="price" placeholder="Preco da Bebida" />
