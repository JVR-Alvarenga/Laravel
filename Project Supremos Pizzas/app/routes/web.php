...
Route::get('/create/pizza/especial', [PizzaEspecialController::class, 'create'])->name('createEspecial');
Route::post('/create/pizza/especial/action', [PizzaEspecialController::class, 'createAction'])->name('createEspecialAction');